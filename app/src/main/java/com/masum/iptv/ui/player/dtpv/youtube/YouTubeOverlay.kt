package com.masum.iptv.ui.player.dtpv.youtube
...
import com.masum.iptv.ui.player.dtpv.youtube.views.CircleClipTapView
...
import com.masum.iptv.ui.player.dtpv.PlayerDoubleTapListener
import com.masum.iptv.ui.player.dtpv.SeekListener
import com.masum.iptv.ui.player.dtpv.youtube.views.SecondsView
...
class YouTubeOverlay(context: Context, private val attrs: AttributeSet?) :
    ...
    private fun initializeAttributes() {
        if (attrs != null) {
            ...
            arcSize = a.getDimensionPixelSize(
                ...
                context.resources
                    .getDimensionPixelSize(com.github.vkay94.dtpv.R.dimen.dtpv_yt_arc_size)
            ).toFloat()

            // Colors
            tapCircleColor = a.getColor(
                com.github.vkay94.dtpv.R.styleable.YouTubeOverlay_yt_tapCircleColor,
                ContextCompat.getColor(context, com.github.vkay94.dtpv.R.color.dtpv_yt_tap_circle_color)
            )
            circleBackgroundColor = a.getColor(
                com.github.vkay94.dtpv.R.styleable.YouTubeOverlay_yt_backgroundCircleColor,
                ContextCompat.getColor(context, com.github.vkay94.dtpv.R.color.dtpv_yt_background_circle_color)
            )
            ...
            icon = a.getResourceId(
                ...
                com.github.vkay94.dtpv.R.drawable.ic_play_triangle
            )
            a.recycle()
        } else {
            // Set defaults
            arcSize = context.resources.getDimensionPixelSize(com.github.vkay94.dtpv.R.dimen.dtpv_yt_arc_size)
                .toFloat()
            tapCircleColor = ContextCompat.getColor(context, com.github.vkay94.dtpv.R.color.dtpv_yt_tap_circle_color)
            circleBackgroundColor =
                ContextCompat.getColor(context, com.github.vkay94.dtpv.R.color.dtpv_yt_background_circle_color)
            setAnimationDuration(650L)
            iconAnimationDuration = 750L
            seekSeconds = 10
            textAppearance = com.github.vkay94.dtpv.R.style.YTOSecondsTextAppearance
        }
    }
    ...
    var tapCircleColor: Int
        get() = (findViewById<CircleClipTapView>(R.id.circle_clip_tap_view) as CircleClipTapView).getCircleColor()
        private set(value) {
            (findViewById<CircleClipTapView>(R.id.circle_clip_tap_view) as CircleClipTapView).setCircleColor(
                value
            )
        }
    ...
    var iconAnimationDuration: Long = 750
        ...
        private set(value) {
            (findViewById<View>(R.id.seconds_view) as SecondsView).cycleDuration =
                value
            field = value
        }
    ...
    var icon = 0
        ...
        private set(value) {
            (findViewById<View>(R.id.seconds_view) as SecondsView).icon =
                value
            field = value
        }
